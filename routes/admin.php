...
Route::group(['namespace'=>'Admin','prefix'=>'admin','middleware'=>'auth'],function (){
    ...
    Route::get('/cleancache',function (){
        rmkdir(storage_path('/framework/cache/data'));
...
Route::group(['namespace'=>'Admin','prefix'=>'admin','middleware'=>['auth','permission:system.manage']],function (){
    ...
    Route::group(['middleware' => 'permission:system.config'], function () {
        Route::get('config/edit', 'IndexController@configEdit')->name('admin.config');
        Route::put('config/update', 'IndexController@configUpdate')->name('admin.config.update')->middleware('permission:system.config.update');
    });
    //用户管理
