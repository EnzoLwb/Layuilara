                ...
                <div class="layui-row">
                    ...
                    <div class="layui-col-xs5">
                        <div style="margin-left: 10px;">
                            <img src="{{ captcha_src()}}"  onclick="this.src='{{captcha_src()}}'+Math.random()"  title="看不清，换一个" style="cursor:pointer;" class="layadmin-user-login-codeimg" id="LAY-user-get-vercode"/>
                        </div>
                    </div>
                </div>
            </div>
