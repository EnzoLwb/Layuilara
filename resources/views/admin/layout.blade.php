        ...
        <div class="layui-header">
            ...
            <ul class="layui-nav layui-layout-left">
                ...
                <li class="layui-nav-item layui-hide-xs" lay-unselect>
                    <a href="{{$home_url}}" target="_blank" title="前台">
            ...
            <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
                ...
                <li class="layui-nav-item" lay-unselect>
                    ...
                    <dl class="layui-nav-child">
                        <dd><a lay-href="{{url('/admin/user/'.\Illuminate\Support\Facades\Auth::id().'/edit')}}">基本资料</a></dd>
                        <dd><a lay-href="{{url('/admin/user/'.\Illuminate\Support\Facades\Auth::id().'/edit')}}">修改密码</a></dd>
                        <dd><a href="{{url('/admin/cleancache')}}">清除缓存</a></dd>
                        <hr>
