...
class IndexController extends Controller
{
    ...
    {
        $config = Site::where('type','admin')->pluck('value','key');
        return view('admin.site.admin_config',compact('config'));
    }

    public function configUpdate(Request $request)
    {
        $data = $request->except(['_token','_method']);
        $data['captcha'] = isset($data['captcha']);
        Site::where('type','admin')->delete();
